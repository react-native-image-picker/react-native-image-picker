...
public class ButtonsHelper
{
    ...
    public final @Nullable Item btnUseLastPhoto;
    ...
    public List<String> getTitles()
    {
        ...
        if (btnUseLastPhoto != null)
        {
            result.add(btnUseLastPhoto.title);
        }
    ...
    public List<String> getActions()
    {
        ...
        if (btnUseLastPhoto != null)
        {
            result.add(btnUseLastPhoto.action);
        }
    ...
    {
        Item btnUseLastPhoto = getItemFromOption(options, "useLastPhotoTitle", "lastPhoto");
        ...
        return new ButtonsHelper(btnUseLastPhoto, btnCamera, btnLibrary, btnCancel, customButtons);
    }
