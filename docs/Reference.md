...
| resizeFileTypes               | OK  | OK      | If set, provide a comma-separated list of file extensions to resize to maxWidth and maxHeight, otherwise will keep original resolution                                                                                                                               |
| resizeMaxAspectRatio          | OK  | OK      | If set, provide a maximum aspect ratio to allow resizing to maxWidth and maxHeight, otherwise will keep original resolution                                                                                                                                          |
...
| storageOptions.forceLocal | -  | OK       | If true, will create temp files while resizing in app local space |
