Pod::Spec.new do |s|
  ...
  s.version      = "0.14.3"
  s.license      = "MIT"
  s.homepage     = "https://github.com/erealmsoft/react-native-image-picker"
  s.authors      = { 'Marc Shilling' => 'erealmsoft@gmail.com' }
  ...
  s.source       = { :git => "https://github.com/erealmsoft/react-native-image-picker" }
